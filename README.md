...
[![Version](https://img.shields.io/badge/version-0.13.2-blue.svg)](https://github.com/Flux-Frontiers/KG_utils/releases)
...
> Suchanek, E. G. (2026). *kgmodule-utils: Shared SDK for the KGModule Knowledge-Graph Ecosystem* (Version 0.13.2) [Software]. Flux-Frontiers. https://doi.org/10.5281/zenodo.21284866
